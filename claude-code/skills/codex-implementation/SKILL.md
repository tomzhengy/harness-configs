...
description: Delegate bulk/mechanical work (clear-spec implementation, migrations, data analysis, investigation) to gpt-5.6-sol via codex exec. Use when the spec is clear and taste doesn't matter; it's effectively free.
